...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 3659119463798820796),
      name: 'ParkingEntity',
      lastPropertyId: const obx_int.IdUid(5, 6543275192192860339),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 4273386420425185984),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 745753055994378480),
            name: 'vehicleId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(1, 3869875127489643269),
            relationTarget: 'VehicleEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1534757476852896715),
            name: 'parkingSpaceId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(2, 185908482412989154),
            relationTarget: 'ParkingSpaceEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 1705094045714394339),
            name: 'startTime',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(5, 6543275192192860339),
            name: 'endTime',
            type: 10,
            flags: 0)
      ],
  ...
  obx_int.ModelEntity(
      id: const obx_int.IdUid(2, 1017431737672233911),
      name: 'ParkingSpaceEntity',
      lastPropertyId: const obx_int.IdUid(3, 3856725804582991965),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 1646391039371630593),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 7370615160651319595),
            name: 'address',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 3856725804582991965),
            name: 'pricePerHour',
            type: 8,
            flags: 0)
      ],
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(3, 4572227796409787517),
      name: 'PersonEntity',
      lastPropertyId: const obx_int.IdUid(3, 8245909473352451184),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 7788138860174962528),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 5469534106014502614),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 8245909473352451184),
      ...
      backlinks: <obx_int.ModelBacklink>[]),
  obx_int.ModelEntity(
      id: const obx_int.IdUid(4, 3941235665604717635),
      name: 'VehicleEntity',
      lastPropertyId: const obx_int.IdUid(4, 4859524229897339746),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5239454572945170291),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4501327290697829996),
            name: 'registrationNumber',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 4900432143455415194),
            name: 'ownerId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(3, 8180806390100948933),
            relationTarget: 'PersonEntity'),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 4859524229897339746),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(4, 3941235665604717635),
      lastIndexId: const obx_int.IdUid(3, 8180806390100948933),
